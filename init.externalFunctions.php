...
/**
 * Provide some basic functions. Mostly taken from Wordpress.com
 * @package SimplePHP
...
if (!function_exists('seems_utf8')) {
    ...
    function seems_utf8($Str) {
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            {
                if((ord($Str[$i]) & 0xE0) == 0xC0) $n = 1;
            }
            # 110bbbbb
            else
            {
                if((ord($Str[$i]) & 0xF0) == 0xE0) $n = 2;
            }
            # 1110bbbb
            else
            {
                if((ord($Str[$i]) & 0xF8) == 0xF0) $n = 3;
            }
            # 11110bbb
            else
            {
                if((ord($Str[$i]) & 0xFC) == 0xF8) $n = 4;
            }
            # 111110bb
            else
            {
                if((ord($Str[$i]) & 0xFE) == 0xFC) $n = 5;
            }
            # 1111110b
            else
            {
